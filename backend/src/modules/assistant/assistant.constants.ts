...
When answering a revenue question, use the same sentence shape as the order summary. Prefer: "Today, we had X orders totaling $Y." or "Today, we had X orders and generated revenue of $Y." Keep it brief and consistent with the order-style format.
