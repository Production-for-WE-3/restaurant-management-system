...
import { useCreateAssets, type CreateAssetItemInput } from "@/hooks/use-assets"
...
export default function AddAssetsPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-4">
      <div className="flex items-center justify-between gap-3"><div><h1 className="text-lg font-semibold">Add assets</h1><p className="text-sm text-muted-foreground">Add multiple asset items in one submission.</p></div><Button variant="outline" render={<Link href="/dashboard/assets" />}><ArrowLeft /> View assets</Button></div>
