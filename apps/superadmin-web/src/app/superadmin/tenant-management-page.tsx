        ...
        <section key={tenant.id} className="rounded-lg border p-4">
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {!tenant.slug.startsWith("deleted-") && <Button size="sm" variant="destructive" onClick={() => void deleteTenantRecord(tenant)} disabled={deleteTenant.isPending}>Delete</Button>}
            </div>
          </div>
