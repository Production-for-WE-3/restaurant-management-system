...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // This entire application is the platform superadmin portal. The backend
  // enforces the same rule, but keeping it here prevents ordinary accounts
  // from rendering any copied staff routes if a session is ever misrouted.
